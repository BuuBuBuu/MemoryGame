...
public final class ItemLeaderboardBinding implements ViewBinding {
  ...
  private ItemLeaderboardBinding(@NonNull LinearLayout rootView, @NonNull TextView completionTime,
      @NonNull TextView positionNumber, @NonNull TextView username) {
  ...
  public static ItemLeaderboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.completionTime;
      TextView completionTime = ViewBindings.findChildViewById(rootView, id);
      if (completionTime == null) {
        break missingId;
      }

      id = R.id.positionNumber;
      TextView positionNumber = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemLeaderboardBinding((LinearLayout) rootView, completionTime, positionNumber,
          username);
    }
